...
class IntegrAIDescribe:
    ...
    def describe_region(self, cluster_selected):
        ...
        # for i in range(min(self.initial_positive_set_size, len(inside_caption_set_idx))):
        ...
        # for i in range(min(self.initial_negative_set_size, len(outside_caption_set_idx))):
        ...
        return final_description, descriptions_over_time, positives_selected, negatives_selected, prompt