...
from D5.validator import Validator
from D5.lm_proposer import GPT3_Proposer
from D5.sample_lexical_diversity import lexical_diversity
...
class D5:
    ...
    def validate(self):
        ...
        cur_pointer = 0
        samples_to_validate = random_sample_order[:50]

        print('Filtering out weak hypotheses')
        # enumerate the samples in random order
        with tqdm.tqdm(total=len(samples_to_validate)) as pbar:
            while cur_pointer < len(samples_to_validate):
